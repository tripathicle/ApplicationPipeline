...
4. [Merge & Official CI Build](#-merge--official-ci-build)
5. [Promotion Ladder — DEV → QA → STAGING](#-promotion-ladder--dev--qa--staging)
6. [Canary Release to Production](#-canary-release-to-production)
...
> 📝 **Note:** This README is a living document. Sections marked *"reserved"* will be filled in as the pipeline evolves.  
